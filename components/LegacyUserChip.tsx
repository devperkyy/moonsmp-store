...
// Kept only for the Discord-auth kill-switch window (DISCORD_CLIENT_ID
// unset) — pairs with the old UsernameGate.tsx. Delete both together once
// the Discord sign-in migration is confirmed stable in production.
