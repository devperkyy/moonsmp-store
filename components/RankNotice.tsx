// Site-wide red banner: ranks are cosmetic supporter tags except Moon+ and Moon++.
  ...
  return (
    <div className="mc-alert">
      <p className="mc-text-shadow font-pixel text-[9px] leading-relaxed text-white sm:text-[10px]">
        ⚠ ONLY <span className="text-amber-300">MOON+ & MOON++</span> HAVE RANK BENEFITS — THE REST
